...
<div id="app" class="app">
    ...
    <div class="login login-v2 fw-bold">
        ...
        <div class="login-cover">
            <div class="login-cover-img" style="background-image: url({{ asset('/')}}backend/assets/img/login-bg/login-bg-17.jpg)" data-id="login-cover-image"></div>
            ...
            <div class="login-header">
                <div class="brand">
                    <div class="d-flex align-items-center">
                        <img style=" margin-right: 5px;" src="{{asset('/')}}uploads/logo/laravel.png" height="36px" width="36px" alt="" ><b class="mx-2">USER </b> Login
                    </div>
